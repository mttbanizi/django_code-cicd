...
LOCAL_APPS = [
    'devops.core.apps.CoreConfig',
    'devops.common.apps.CommonConfig',
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'devops.api.exception_handlers.drf_default_with_modifications_exception_handler',
    # 'EXCEPTION_HANDLER': 'devops.api.exception_handlers.hacksoft_proposed_exception_handler',
